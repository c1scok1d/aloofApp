...
public class Tracking {
    ...
    @Expose
    private List<Tracking> positions = null;

    public Tracking(Double latitude, Double longitude) {

    }

    public List<Tracking> getPositions() {
        return positions;
    }

    public void setPositions(List<Tracking> positions) {
